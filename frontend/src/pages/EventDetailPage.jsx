    ...
    try {
      ...
      if (data.isFree) {
        ...
        if (event.redirectionUrl) {
          window.open(event.redirectionUrl, '_blank');
        }
        ...
        <div className="relative z-10 container mx-auto px-6 md:px-12">
          ...
          <div className="detail-header">
            <div className="flex flex-wrap gap-2 mb-4">
              ...
              {(isNoReg || event.registrationFee === 0) && (
                ...
                <div className="p-7 pb-14">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-black font-bold">
                            {event.registrationFee === 0 ? "Free" : `₹${event.registrationFee}${isTeamEvent ? (event.isFeePerTeam ? " per team" : " per member") : ""}`}
                          </div>
                        </div>
                      </div>
                    )}
                  ...
                  <div className="mt-8">
                    {isNoReg ? (
                      ...
                      <div className="block w-full px-6 py-4 bg-slate-100 text-slate-700 border-2 border-slate-700 shadow-[4px_4px_0_#334155] text-center font-heading text-xl uppercase">
                        <span className="flex items-center justify-center gap-2"><CheckCircle size={24} /> Event Completed</span>
                      </div>
                  ...
                  {event.whatsappLink && (
                    <div className="mt-4">
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="block w-full px-6 py-4 bg-green-500 text-white border-2 border-black shadow-[4px_4px_0_#000] text-center font-heading text-lg hover:translate-y-1 hover:shadow-none transition-all uppercase"
                      >
            ...
            <form onSubmit={handlePayment} className="p-6 md:p-8 space-y-6 max-h-[70vh] overflow-y-auto">
              <div>
                ...
                <p className="text-slate-500 font-mono text-sm uppercase">
                  Category: {event.category} • Fee: {event.registrationFee === 0 ? "Free" : `₹${event.registrationFee}`}
                  {event.registrationFee > 0 && event.isFeePerTeam ? " (Per Team)" : ""}
                </p>
              </div>
