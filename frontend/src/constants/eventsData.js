...
export const specialEvents = [
  // Pre-fest special events
  {
    ...
    tagline: "Dance & Vibe",
    description:
      "Ciencia 2K26 Flashmob is taking over AMB Mall! An electrifying surprise dance performance to kick off the fest vibes.",
    category: "Special",
    teamSize: "Group",
  ...
  },
  {
    ...
    description:
      "Join Ciencia 2K26 for a powerful morning run themed around Women Empowerment — 'The Women's Give to Gain'. Lace up and run for a cause that matters at the scenic Jalavihar, Necklace Road.",
    category: "Special",
    teamSize: "Individual",
    registrationRequired: false,
